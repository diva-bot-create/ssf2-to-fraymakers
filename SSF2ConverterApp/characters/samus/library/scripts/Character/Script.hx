// API Script for samus — converted from SSF2
...
function resetChargeOnDeath(arg0) {
	self.updateAnimationStatsMetadata(/* TODO: setGlobalVariable */ "SamusNSpecCharge", 0);
	self.updateAnimationStatsMetadata(/* TODO: setGlobalVariable */ "SamusNSpecBoost", 0);
	return;
}
