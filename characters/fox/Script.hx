...
// ── Fox-specific overrides (ported from SSF2 FoxExt.as) ──
...
function resetChargeOnDeath(param1:* = null) {
         ...
         // TODO: setGlobalVariable("FoxDSpecCharge", 0);
         // TODO: setGlobalVariable("FoxDSpecFrame", 0);
         // TODO: setGlobalVariable("FoxDSpecDoIt", false);
