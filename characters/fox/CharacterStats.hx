// CharacterStats for Fox
// Source: FoxExt.as → getOwnStats()
{
	...
	gravity: 2.3, // SSF2: gravity
	shortHopSpeed: 16, // SSF2: shortHopSpeed
	jumpSpeed: 24, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [25], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 17, // SSF2: max_ySpeed
	fastFallSpeed: 20, // SSF2: fastFallSpeed
	friction: 1.3, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.25, // SSF2: accel_start
	walkSpeedAcceleration: 0.25, // SSF2: accel_start
	walkSpeedCap: 8, // SSF2: norm_xSpeed
	dashSpeed: 12.33, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 8, // SSF2: norm_xSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["fox_hurt", "fox_hurt2"],
	hurtHeavyVoiceIds: ["fox_hurtBad", "fox_hurtBad2"],
	koVoiceIds: ["fox_death", "fox_death2", "fox_hurt2", "fox_starKO"],
