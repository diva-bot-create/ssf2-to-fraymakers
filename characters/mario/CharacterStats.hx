// CharacterStats for Mario
// Source: MarioExt.as → getOwnStats()
{
	...
	//ECB STATS
	floorHeadPosition: 46, // SSF2: height
	floorHipWidth: 26, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 46, // SSF2: height
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["mario_edgegrab", "mario_hurt2"],
	hurtHeavyVoiceIds: ["mario_hurtBad", "mario_hurtBad2"],
	koVoiceIds: ["mario_dead", "mario_dead2", "mario_hurtBad", "mario_star"],
