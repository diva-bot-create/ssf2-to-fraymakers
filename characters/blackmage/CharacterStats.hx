// CharacterStats for Blackmage
// Source: BlackmageExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("blackmage"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 92, // SSF2: weight1
	...
	friction: 0.76, // SSF2: abs(decel_rate)
	...
	//ECB STATS
	floorHeadPosition: 47, // SSF2: height
	floorHipWidth: 41, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 47, // SSF2: height
