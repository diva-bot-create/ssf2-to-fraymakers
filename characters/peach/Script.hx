...
// ── Peach-specific overrides (ported from SSF2 PeachExt.as) ──
...
function initialize() {
         ...
         this.originalMusic = // TODO: SSF2API.getCurrentMusicInfo();
      
}

function setSpecialEvent(param1:Bool) {

         this.specialEvent = param1;
