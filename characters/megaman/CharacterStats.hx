// CharacterStats for Megaman
// Source: MegamanExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("megaman"),
	...
	fastFallSpeed: 15.7, // SSF2: fastFallSpeed
	friction: 1.6, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.075, // SSF2: accel_start
	walkSpeedAcceleration: 0.075, // SSF2: accel_start
	walkSpeedCap: 6.8, // SSF2: norm_xSpeed
	dashSpeed: 8.1, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 6.8, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1, // SSF2: accel_rate
	runSpeedCap: 9, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1, // SSF2: accel_rate
	groundSpeedCap: 9, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 1.6, // SSF2: accel_rate_air
	aerialSpeedCap: 9, // SSF2: max_xSpeed
	...
	hurtMediumVoiceIds: [],
	hurtHeavyVoiceIds: [],
	koVoiceIds: ["megaman_dead", "megaman_dead"],
