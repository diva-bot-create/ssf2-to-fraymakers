// CharacterStats for Marth
// Source: MarthExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("marth"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 87, // SSF2: weight1
	gravity: 0.95, // SSF2: gravity
	shortHopSpeed: 9.5, // SSF2: shortHopSpeed
	jumpSpeed: 14, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [13.5], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 13, // SSF2: max_ySpeed
	fastFallSpeed: 15.5, // SSF2: fastFallSpeed
	...
	dashSpeed: 10.35, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 6, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1.25, // SSF2: accel_rate
	runSpeedCap: 11.5, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1.25, // SSF2: accel_rate
	groundSpeedCap: 11.5, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.7, // SSF2: accel_rate_air
	aerialSpeedCap: 11.5, // SSF2: max_xSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["marth_hurt", "marth_hurt2"],
	hurtHeavyVoiceIds: ["marth_hurtBad", "marth_hurtBad2"],
	koVoiceIds: ["marth_vc_dead", "marth_vc_dead2", "marth_vc_dead", "marth_starko"],
