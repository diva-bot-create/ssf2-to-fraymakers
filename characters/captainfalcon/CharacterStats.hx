// CharacterStats for Captainfalcon
// Source: CaptainfalconExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("captainfalcon"),
	...
	terminalVelocity: 15, // SSF2: max_ySpeed
	fastFallSpeed: 18, // SSF2: fastFallSpeed
	friction: 1.35, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.355, // SSF2: accel_start
	walkSpeedAcceleration: 0.355, // SSF2: accel_start
	walkSpeedCap: 5.6, // SSF2: norm_xSpeed
	dashSpeed: 12.6, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 5.6, // SSF2: norm_xSpeed
	runSpeedAcceleration: 0.9, // SSF2: accel_rate
	runSpeedCap: 14, // SSF2: max_xSpeed
	groundSpeedAcceleration: 0.9, // SSF2: accel_rate
	groundSpeedCap: 14, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.85, // SSF2: accel_rate_air
	aerialSpeedCap: 14, // SSF2: max_xSpeed
	...
	floorHipWidth: 22, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 58, // SSF2: height
	aerialHipWidth: 22, // SSF2: width
	aerialHipXOffset: 0,
	aerialHipYOffset: 0,
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["falcon_hurt", "falcon_hurt2"],
	hurtHeavyVoiceIds: ["falcon_hurtBad", "falcon_hurtBad2"],
	koVoiceIds: ["falcon_death", "falcon_death2", "falcon_hurtBad2", "falcon_starKO"],
