// CharacterStats for Isaac
// Source: IsaacExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("isaac"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 102, // SSF2: weight1
	gravity: 1.56, // SSF2: gravity
	shortHopSpeed: 14.5, // SSF2: shortHopSpeed
	jumpSpeed: 19, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [19], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 10.5, // SSF2: max_ySpeed
	fastFallSpeed: 16, // SSF2: fastFallSpeed
	friction: 1.4, // SSF2: abs(decel_rate)
	...
	dodgeRollSpeed: 13.5, // SSF2: dodgeSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["darcy_hurt", "darcy_hurt2"],
	hurtHeavyVoiceIds: ["darcy_hurtBad", "darcy_hurtBad2"],
	koVoiceIds: ["darcy_dead", "darcy_dead2", "darcy_hurt", "darcy_starKO"],
