// CharacterStats for Sandbag
// Source: SandbagExt.as → getOwnStats()
{
	...
	shortHopSpeed: 6.5, // SSF2: shortHopSpeed
	...
	walkSpeedInitial: 0, // SSF2: accel_start
	walkSpeedAcceleration: 0, // SSF2: accel_start
	walkSpeedCap: 8, // SSF2: norm_xSpeed
	dashSpeed: 7.2, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 8, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1.1, // SSF2: accel_rate
	runSpeedCap: 8, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1.1, // SSF2: accel_rate
	groundSpeedCap: 8, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.7, // SSF2: accel_rate_air
	aerialSpeedCap: 8, // SSF2: max_xSpeed
