// Script.hx for Pikachu
// Ported from SSF2 PikachuExt.as
...
// ── Pikachu-specific overrides (ported from SSF2 PikachuExt.as) ──
...
function isShinyPikachu() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[4] == 4284749056;
