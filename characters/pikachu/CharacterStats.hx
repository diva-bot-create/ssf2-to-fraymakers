// CharacterStats for Pikachu
// Source: PikachuExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("pikachu"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 80, // SSF2: weight1
	...
	dashSpeed: 10.98, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 5, // SSF2: norm_xSpeed
	runSpeedAcceleration: 0.9, // SSF2: accel_rate
	runSpeedCap: 12.2, // SSF2: max_xSpeed
	groundSpeedAcceleration: 0.9, // SSF2: accel_rate
	groundSpeedCap: 12.2, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.77, // SSF2: accel_rate_air
	aerialSpeedCap: 12.2, // SSF2: max_xSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["pika_hurt1", "pika_hurt2"],
	hurtHeavyVoiceIds: ["pika_hitHard", "pika_hitHard2"],
	koVoiceIds: ["pika_KO", "pika_KO2", "pika_hitHard", "pika_starko"],
