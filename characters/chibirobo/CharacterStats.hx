// CharacterStats for Chibirobo
// Source: ChibiroboExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("chibirobo"),
	...
	shortHopSpeed: 13, // SSF2: shortHopSpeed
	jumpSpeed: 17.8, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [17.8], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 13.5, // SSF2: max_ySpeed
	fastFallSpeed: 16, // SSF2: fastFallSpeed
	friction: 1.5, // SSF2: abs(decel_rate)
	...
	//ECB STATS
	floorHeadPosition: 45, // SSF2: height
	floorHipWidth: 31, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 45, // SSF2: height
	...
	dodgeRollSpeed: 17, // SSF2: dodgeSpeed
