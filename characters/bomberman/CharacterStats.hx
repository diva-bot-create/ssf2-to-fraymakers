// CharacterStats for Bomberman
// Source: BombermanExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("bomberman"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 97, // SSF2: weight1
	gravity: 1.7, // SSF2: gravity
	shortHopSpeed: 11.2, // SSF2: shortHopSpeed
	jumpSpeed: 19.2, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [19.2], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 15.1, // SSF2: max_ySpeed
	fastFallSpeed: 17.1, // SSF2: fastFallSpeed
	...
	dashSpeed: 9.63, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 4.1, // SSF2: norm_xSpeed
	runSpeedAcceleration: 2, // SSF2: accel_rate
	runSpeedCap: 10.7, // SSF2: max_xSpeed
	groundSpeedAcceleration: 2, // SSF2: accel_rate
	groundSpeedCap: 10.7, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 2.5, // SSF2: accel_rate_air
	aerialSpeedCap: 10.7, // SSF2: max_xSpeed
	aerialFriction: 0.23, // SSF2: abs(decel_rate_air)
	wallJumpXSpeed: 8.5,
	wallJumpYSpeed: 14,
	wallJumpLimit: 1,
