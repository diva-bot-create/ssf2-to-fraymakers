// Script.hx for Lucario
// Ported from SSF2 LucarioExt.as
...
// ── Lucario-specific overrides (ported from SSF2 LucarioExt.as) ──
...
function isShinyLucario() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[0] == 4294441305;
...
function updateAuraDamage(param1:Array<Dynamic>) {

         var _local2:* = 0;
         while(_local2 < param1.length)
         {
            self.updateAttackBoxStats(param1[_local2],{"damage":self.getAttackBoxStat(param1[_local2],"damage") * this.auraMultiplier});
            _local2++;
         }
      
}

function updateAuraPaws(param1:* = null) {
         ...
         self.getStanceMC().aura1.gotoAndStop(_local2);
         self.getStanceMC().aura2.gotoAndStop(_local2);
