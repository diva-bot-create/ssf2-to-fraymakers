...
function update() {
         ...
         {
            if(self.getStanceMC().shieldframe.alpha > 0)
            {
               self.getStanceMC().shieldframe.alpha = self.getStanceMC().shieldframe.alpha - 0.3;
               self.getStanceMC().shieldframe.scaleX = self.getStanceMC().shieldframe.scaleX - 0.35;
            }
         }
