// CharacterStats for Dedede
// Source: DededeExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("dedede"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 112, // SSF2: weight1
	...
	terminalVelocity: 11, // SSF2: max_ySpeed
	...
	walkSpeedCap: 3.8, // SSF2: norm_xSpeed
	dashSpeed: 7.56, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 3.8, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1.5, // SSF2: accel_rate
	runSpeedCap: 8.4, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1.5, // SSF2: accel_rate
	groundSpeedCap: 8.4, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.5, // SSF2: accel_rate_air
	aerialSpeedCap: 8.4, // SSF2: max_xSpeed
	...
	floorHipWidth: 50, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 66, // SSF2: height
	aerialHipWidth: 50, // SSF2: width
	aerialHipXOffset: 0,
	aerialHipYOffset: 0,
	...
	dodgeRollSpeed: 16.5, // SSF2: dodgeSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["ssf2_snd_vfx_dedede_hurt01", "ssf2_snd_vfx_dedede_hurt02"],
	hurtHeavyVoiceIds: ["ssf2_snd_vfx_dedede_hurtBad01", "ssf2_snd_vfx_dedede_hurtBad02"],
	koVoiceIds: ["ssf2_snd_vfx_dedede_dead01", "ssf2_snd_vfx_dedede_dead02", "ssf2_snd_vfx_dedede_hurtBad01", "ssf2_snd_vfx_dedede_starKO"],
