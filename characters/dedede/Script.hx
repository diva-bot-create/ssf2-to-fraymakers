...
function isMonoDedede() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[0] == 4286405937;
      
}

function isShadowDedede() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[0] == 4291042372;
      
}

function isKingDMind() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[0] == 4286595279;
      
}

function isRetroDedede() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[0] == 4290248768;
      
}

function isMetalDedede() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[0] == 4290361785;
