// CharacterStats for Gameandwatch
// Source: GameandwatchExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("gameandwatch"),
	...
	shortHopSpeed: 10.5, // SSF2: shortHopSpeed
	...
	terminalVelocity: 9.2, // SSF2: max_ySpeed
	fastFallSpeed: 15.1, // SSF2: fastFallSpeed
	...
	dashSpeed: 9.36, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 4.1, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1, // SSF2: accel_rate
	runSpeedCap: 10.4, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1, // SSF2: accel_rate
	groundSpeedCap: 10.4, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.75, // SSF2: accel_rate_air
	aerialSpeedCap: 10.4, // SSF2: max_xSpeed
	...
	hurtMediumVoiceIds: [],
	hurtHeavyVoiceIds: [],
	koVoiceIds: ["gameandwatch_starko"],
