// CharacterStats for Zamus
// Source: ZamusExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("zamus"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 81, // SSF2: weight1
	gravity: 1.43, // SSF2: gravity
	shortHopSpeed: 10, // SSF2: shortHopSpeed
	jumpSpeed: 18.5, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [19.3], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 12, // SSF2: max_ySpeed
	fastFallSpeed: 16, // SSF2: fastFallSpeed
	friction: 1.52, // SSF2: abs(decel_rate)
	...
	//ECB STATS
	floorHeadPosition: 56, // SSF2: height
	floorHipWidth: 30, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 56, // SSF2: height
	...
	dodgeRollSpeed: 11.5, // SSF2: dodgeSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["zamus_hurt", "zamus_hurt2"],
	hurtHeavyVoiceIds: ["zamus_hurtBad", "zamus_hurtBad2"],
	koVoiceIds: ["zamus_dead", "zamus_dead2", "zamus_hurtBad", "zamus_starko"],
