// CharacterStats for Sonic
// Source: SonicExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("sonic"),
	...
	shortHopSpeed: 9, // SSF2: shortHopSpeed
	jumpSpeed: 16.5, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [16.5], // SSF2: jumpSpeedMidair → array
	...
	dashSpeed: 13.62, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 7, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1.4, // SSF2: accel_rate
	runSpeedCap: 15.137, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1.4, // SSF2: accel_rate
	groundSpeedCap: 15.137, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.75, // SSF2: accel_rate_air
	aerialSpeedCap: 15.137, // SSF2: max_xSpeed
	aerialFriction: 0.26, // SSF2: abs(decel_rate_air)
	wallJumpXSpeed: 8.5,
	wallJumpYSpeed: 14,
	wallJumpLimit: 1,
	...
	floorHipWidth: 24, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 52, // SSF2: height
	aerialHipWidth: 24, // SSF2: width
	aerialHipXOffset: 0,
	aerialHipYOffset: 0,
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["sonic_hurt", "sonic_hurt2"],
	hurtHeavyVoiceIds: ["sonic_hurtBad", "sonic_hurtBad2"],
	koVoiceIds: ["sonic_death", "sonic_death2", "sonic_hurt2", "sonic_starko"],
