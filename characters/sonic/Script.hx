...
function update() {
         ...
         {
            this.cpuFSState = this.CPU_STATE_INIT;
         }
...
function getFeetFrames() {

         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4286025983)
         {
            return 1;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294962879)
         {
            return 7;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294931831)
         {
            return 3;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294959355)
         {
            return 13;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4285889919)
         {
            return 9;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294769919)
         {
            return 11;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294932467)
         {
            return 15;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4284546933)
         {
            return 5;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294950284)
         {
            return 17;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4287751167)
         {
            return 19;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4292660479)
         {
            return 23;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4293045375)
         {
            return 21;
         }
         if(self.getPaletteSwapData().paletteSwap.replacements[0] == 4294572537)
         {
            return 25;
         }
         return 1;
