// CharacterStats for Luigi
// Source: LuigiExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("luigi"),
	...
	doubleJumpSpeeds: [15.1], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 8, // SSF2: max_ySpeed
	fastFallSpeed: 14, // SSF2: fastFallSpeed
	friction: 0.35, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.572, // SSF2: accel_start
	walkSpeedAcceleration: 0.572, // SSF2: accel_start
	walkSpeedCap: 3.5, // SSF2: norm_xSpeed
	dashSpeed: 8.73, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 3.5, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1, // SSF2: accel_rate
	runSpeedCap: 9.7, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1, // SSF2: accel_rate
	groundSpeedCap: 9.7, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.96, // SSF2: accel_rate_air
	aerialSpeedCap: 9.7, // SSF2: max_xSpeed
	aerialFriction: 0.09, // SSF2: abs(decel_rate_air)
	wallJumpXSpeed: 8.5,
	wallJumpYSpeed: 14,
	wallJumpLimit: 1,
	...
	dodgeRollSpeed: 12, // SSF2: dodgeSpeed
	...
	ledgeRollSpeed: 14,
	ledgeRollSpeedStartFrame: 5, // SSF2: climb_roll_delay
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["luigi_hurt", "luigi_hurt2"],
	hurtHeavyVoiceIds: ["luigi_hurtBad", "luigi_hurtBad2"],
	koVoiceIds: ["luigi_dead", "luigi_dead2", "luigi_hurt2", "luigi_star"],
