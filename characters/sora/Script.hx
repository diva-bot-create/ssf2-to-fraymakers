...
// ── Sora-specific overrides (ported from SSF2 SoraExt.as) ──
...
function initialize() {
         ...
         this.spellHUD = new SoraSpellHUD();
         if(self.getHealthBox())
         {
            self.getHealthBox().addChild(this.spellHUD);
         }
         this.spellHUD.x = -5;
         this.spellHUD.y = -15;
         self.createTimer(1,-1,this.animateSpellHUD,{
            "persistent":true,
            "hitStunPause":false
         });
...
function updateSpellHUD(param1:String) {

         this.spellHUD.gotoAndStop(param1);
         self.createTimer(20,1,this.playBlip,{
            "persistent":true,
            "hitStunPause":false
         });
