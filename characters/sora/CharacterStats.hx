// CharacterStats for Sora
// Source: SoraExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("sora"),
	...
	gravity: 1.32, // SSF2: gravity
	shortHopSpeed: 10, // SSF2: shortHopSpeed
	jumpSpeed: 15.9, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [15.9], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 11.5, // SSF2: max_ySpeed
	fastFallSpeed: 14, // SSF2: fastFallSpeed
	friction: 1.09, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.41, // SSF2: accel_start
	walkSpeedAcceleration: 0.41, // SSF2: accel_start
	walkSpeedCap: 4.9, // SSF2: norm_xSpeed
	dashSpeed: 8.82, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 4.9, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1.3, // SSF2: accel_rate
	runSpeedCap: 9.8, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1.3, // SSF2: accel_rate
	groundSpeedCap: 9.8, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 1, // SSF2: accel_rate_air
	aerialSpeedCap: 9.8, // SSF2: max_xSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["sora_hurt", "sora_hurt2"],
	hurtHeavyVoiceIds: ["sora_hurtBad", "sora_hurtBad2"],
	koVoiceIds: ["sora_die", "khII_starko"],
