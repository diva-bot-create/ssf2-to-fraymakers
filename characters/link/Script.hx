...
// ── Link-specific overrides (ported from SSF2 LinkExt.as) ──
...
function isRetroLink() {

         return self.getPaletteSwapData().paletteSwapPA.replacements[37] == 4283227208;
