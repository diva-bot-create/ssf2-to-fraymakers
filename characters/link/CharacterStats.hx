// CharacterStats for Link
// Source: LinkExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("link"),
	...
	friction: 1.39, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.385, // SSF2: accel_start
	walkSpeedAcceleration: 0.385, // SSF2: accel_start
	walkSpeedCap: 5.2, // SSF2: norm_xSpeed
	dashSpeed: 7.65, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 5.2, // SSF2: norm_xSpeed
	...
	floorHipWidth: 41, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 52, // SSF2: height
	aerialHipWidth: 41, // SSF2: width
	aerialHipXOffset: 0,
	aerialHipYOffset: 0,
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["link_hurt", "link_hurt2"],
	hurtHeavyVoiceIds: ["link_hurtBad", "link_hurtBad2"],
	koVoiceIds: ["link_death", "link_death2", "link_hurt2", "link_starko"],
