// CharacterStats for Rayman
// Source: RaymanExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("rayman"),
	...
	dodgeRollSpeed: 8, // SSF2: dodgeSpeed
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["ssf2_snd_vfx_rayman_hurt01", "ssf2_snd_vfx_rayman_hurt02"],
	hurtHeavyVoiceIds: ["ssf2_snd_vfx_rayman_hurtbad01", "ssf2_snd_vfx_rayman_hurtbad02"],
	koVoiceIds: ["ssf2_snd_vfx_rayman_dead01", "ssf2_snd_vfx_rayman_dead02", "ssf2_snd_vfx_rayman_hurt01", "ssf2_snd_vfx_rayman_starKO"],
