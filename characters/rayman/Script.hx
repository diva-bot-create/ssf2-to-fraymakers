...
function plumChecker() {

         if(this.plum != null && !this.plum.isDisposed())
         {
            this.plum.addEventListener(SSF2Event.ENEMY_DESTROYED,this.clearPlum);
         }
      
}

function clearPlum(param1:*) {
