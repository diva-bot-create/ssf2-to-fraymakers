// CharacterStats for Samus
// Source: SamusExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("samus"),
	...
	gravity: 1.15, // SSF2: gravity
	shortHopSpeed: 11.7, // SSF2: shortHopSpeed
	jumpSpeed: 16, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [14.8], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 8.5, // SSF2: max_ySpeed
	fastFallSpeed: 13, // SSF2: fastFallSpeed
	friction: 1.27, // SSF2: abs(decel_rate)
	...
	hurtMediumVoiceIds: [],
	hurtHeavyVoiceIds: [],
	koVoiceIds: ["samus_starko", "samus_starko"],
