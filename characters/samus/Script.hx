...
function update() {
         ...
         if(self.getStanceMC().canspark != null)
         {
            _local1 = true;
         }
         if(self.getGlobalVariable("SamusNSpecCharge") == 70)
         {
            ...
            {
               this.colTrans.redOffset = 30;
               this.colTrans.greenOffset = 30;
               this.colTrans.blueOffset = 30;
            }
            else if(this.tintClock == 1 && _local1)
            {
               this.colTrans.redOffset = 18;
               this.colTrans.greenOffset = 18;
            ...
            if(_local1)
            {
               self.getStanceMC().canspark.gotoAndStop(this.tintClock + 2);
            }
         ...
         else
         {
            ...
            if(_local1)
            {
               self.getStanceMC().canspark.gotoAndStop(1);
            }
            if(this.tintClock != -1)
            {
               this.colTrans.redOffset = 0;
