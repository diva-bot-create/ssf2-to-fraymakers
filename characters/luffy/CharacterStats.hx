// CharacterStats for Luffy
// Source: LuffyExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("luffy"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 98, // SSF2: weight1
	gravity: 1.13, // SSF2: gravity
	shortHopSpeed: 8.5, // SSF2: shortHopSpeed
	...
	terminalVelocity: 14.5, // SSF2: max_ySpeed
	fastFallSpeed: 20.5, // SSF2: fastFallSpeed
	friction: 1.03, // SSF2: abs(decel_rate)
	...
	runSpeedAcceleration: 1.75, // SSF2: accel_rate
	runSpeedCap: 10, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1.75, // SSF2: accel_rate
	...
	techRollSpeed: 18,
	techRollSpeedStartFrame: 0, // SSF2: tech_roll_delay
	...
	ledgeRollSpeed: 14,
	ledgeRollSpeedStartFrame: 0, // SSF2: climb_roll_delay
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["luffy_hurt1", "luffy_hurt2"],
	hurtHeavyVoiceIds: ["luffy_hurtBad1", "luffy_hurtBad2"],
	koVoiceIds: ["luffy_death1", "luffy_death2", "luffy_hurt1", "luffy_starKO"],
