...
// ── Luffy-specific overrides (ported from SSF2 LuffyExt.as) ──
...
function initialize() {
         ...
         self.addEventListener(SSF2Event.CHAR_KO_DEATH,this.resetUses,{"persistent":true});
...
function resetUses(param1:* = null) {

         this.usedSideB = false;
         self.resetDownB();
      
}

function resetDownB(param1:* = null) {
