// CharacterStats for Lloyd
// Source: LloydExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("lloyd"),
	...
	jumpSpeed: 14.5, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [14], // SSF2: jumpSpeedMidair → array
	...
	aerialFriction: 0.12, // SSF2: abs(decel_rate_air)
	wallJumpXSpeed: 8.5,
	wallJumpYSpeed: 14,
	wallJumpLimit: 1,
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["lloyd_hurt", "lloyd_hurt2"],
	hurtHeavyVoiceIds: ["lloyd_hitHard1", "lloyd_hitHard2"],
	koVoiceIds: ["lloyd_dead", "lloyd_dead2", "lloyd_hitHard2", "lloyd_starko"],
