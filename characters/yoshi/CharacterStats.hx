// CharacterStats for Yoshi
// Source: YoshiExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("yoshi"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 111, // SSF2: weight1
	gravity: 1.4, // SSF2: gravity
	shortHopSpeed: 12.2, // SSF2: shortHopSpeed
	jumpSpeed: 16.6, // SSF2: jumpSpeed
	jumpSpeedForwardInitialXSpeed: 3,
	jumpSpeedBackwardInitialXSpeed: -3,
	doubleJumpSpeeds: [11], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 14, // SSF2: max_ySpeed
	fastFallSpeed: 15, // SSF2: fastFallSpeed
	friction: 0.92, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.444, // SSF2: accel_start
	walkSpeedAcceleration: 0.444, // SSF2: accel_start
	walkSpeedCap: 4.5, // SSF2: norm_xSpeed
	dashSpeed: 8.24, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 4.5, // SSF2: norm_xSpeed
	runSpeedAcceleration: 1, // SSF2: accel_rate
	runSpeedCap: 9.15, // SSF2: max_xSpeed
	groundSpeedAcceleration: 1, // SSF2: accel_rate
	groundSpeedCap: 9.15, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 1.2, // SSF2: accel_rate_air
	aerialSpeedCap: 9.15, // SSF2: max_xSpeed
	...
	floorHipWidth: 21, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 49, // SSF2: height
	aerialHipWidth: 21, // SSF2: width
	aerialHipXOffset: 0,
	aerialHipYOffset: 0,
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["yoshi_vc_hurt", "yoshi_vc_hurt"],
	hurtHeavyVoiceIds: ["yoshi_vc_hurtBad", "yoshi_vc_hurtBad2"],
	koVoiceIds: ["yoshi_vc_death1", "yoshi_vc_death2", "yoshi_vc_hurt", "yoshi_vc_starKO"],
