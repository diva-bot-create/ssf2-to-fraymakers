// CharacterStats for Ness
// Source: NessExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("ness"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 94, // SSF2: weight1
	gravity: 1.08, // SSF2: gravity
	...
	doubleJumpSpeeds: [12], // SSF2: jumpSpeedMidair → array
	terminalVelocity: 11.9, // SSF2: max_ySpeed
	fastFallSpeed: 15, // SSF2: fastFallSpeed
	friction: 1.18, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.47, // SSF2: accel_start
	walkSpeedAcceleration: 0.47, // SSF2: accel_start
	walkSpeedCap: 4.3, // SSF2: norm_xSpeed
	dashSpeed: 8.28, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 4.3, // SSF2: norm_xSpeed
	...
	aerialSpeedAcceleration: 0.83, // SSF2: accel_rate_air
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["ness_hurt1", "ness_hurt2"],
	hurtHeavyVoiceIds: ["ness_hurtBad1", "ness_hurtBad2"],
	koVoiceIds: ["ness_death1", "ness_death2", "ness_hurtBad2", "ness_starKO"],
