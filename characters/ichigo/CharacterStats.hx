// CharacterStats for Ichigo
// Source: IchigoExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("ichigo"),
	...
	runSpeedAcceleration: 0.8, // SSF2: accel_rate
	runSpeedCap: 12, // SSF2: max_xSpeed
	groundSpeedAcceleration: 0.8, // SSF2: accel_rate
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["ichigo_hurt", "ichigo_hurt2"],
	hurtHeavyVoiceIds: ["ichigo_hithard"],
	koVoiceIds: ["ichigo_dead", "ichigo_dead2", "ichigo_hithard", "ichigo_starko"],
