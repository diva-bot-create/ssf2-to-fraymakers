// Script.hx for Ichigo
// Ported from SSF2 IchigoExt.as
...
// ── Ichigo-specific overrides (ported from SSF2 IchigoExt.as) ──
...
function initialize() {
         ...
         if(getCostume() < 0)
         {
            _local1.jump = "ichigo_jump";
            _local1.hurt = "ichigo_hurt";
            _local1.hurt2 = "ichigo_hurt2";
            _local1.hurtBad = "ichigo_hithard";
            _local1.dead = "ichigo_dead";
            _local1.dead2 = "ichigo_dead2";
            _local1.screenko = "ichigo_hithard";
            _local1.starko = "ichigo_starko";
         }
         else if(getPaletteSwapData().paletteSwapPA.replacements[1] == 4290429636)
         {
            _local1.jump = "zangetsu_jump";
            _local1.hurt = "zangetsu_hurt";
            _local1.hurt2 = "zangetsu_hurt2";
            _local1.hurtBad = "zangetsu_hithard";
            _local1.dead = "zangetsu_dead";
            _local1.dead2 = "zangetsu_dead2";
            _local1.screenko = "zangetsu_hithard";
            _local1.starko = "zangetsu_starko";
         }
...
function isZangetsu() {
         ...
         return self.getPaletteSwapData().paletteSwapPA.replacements[1] == 4290429636;
