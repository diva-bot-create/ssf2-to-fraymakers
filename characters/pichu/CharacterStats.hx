// CharacterStats for Pichu
// Source: PichuExt.as → getOwnStats()
{
	spriteContent: self.getResource().getContent("pichu"),

	//GENERIC STATS
	baseScaleX: 1.0,
	baseScaleY: 1.0,
	//GENERIC STATS
	weight: 74, // SSF2: weight1
	...
	terminalVelocity: 11.7, // SSF2: max_ySpeed
	fastFallSpeed: 14, // SSF2: fastFallSpeed
	friction: 1.19, // SSF2: abs(decel_rate)
	walkSpeedInitial: 0.4, // SSF2: accel_start
	walkSpeedAcceleration: 0.4, // SSF2: accel_start
	walkSpeedCap: 5, // SSF2: norm_xSpeed
	dashSpeed: 12.33, // SSF2: accel_start_dash (approx) (estimated as 90% of max_xSpeed)
	runSpeedInitial: 5, // SSF2: norm_xSpeed
	runSpeedAcceleration: 0.9, // SSF2: accel_rate
	runSpeedCap: 13.7, // SSF2: max_xSpeed
	groundSpeedAcceleration: 0.9, // SSF2: accel_rate
	groundSpeedCap: 13.7, // SSF2: max_xSpeed
	aerialSpeedAcceleration: 0.7, // SSF2: accel_rate_air
	aerialSpeedCap: 13.7, // SSF2: max_xSpeed
	...
	floorHipWidth: 16, // SSF2: width
	floorHipXOffset: 0,
	floorHipYOffset: 0,
	floorFootPosition: 0,
	aerialHeadPosition: 40, // SSF2: height
	aerialHipWidth: 16, // SSF2: width
	aerialHipXOffset: 0,
	aerialHipYOffset: 0,
	...
	hurtLightVoiceIds: [],
	hurtMediumVoiceIds: ["ssf2_snd_vfx_pichu_hurt01", "ssf2_snd_vfx_pichu_hurt02"],
	hurtHeavyVoiceIds: ["ssf2_snd_vfx_pichu_hurtBad01", "ssf2_snd_vfx_pichu_hurtBad02"],
	koVoiceIds: ["ssf2_snd_vfx_pichu_dead01", "ssf2_snd_vfx_pichu_dead02", "ssf2_snd_vfx_pichu_hurt01", "ssf2_snd_vfx_pichu_starKO"],
